/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e0a4e23a167c13e9af608936f8da39d3)
// Runtime types generated with workerd@1.20250712.0 2025-07-11 
declare namespace Cloudflare {
	interface Env {
		...
		EMAIL: string;
		RESEND_API: string;
		CREDENTIALS_DURABLE_OBJECT: DurableObjectNamespace<import("./src/index").CredentialsDurableObject>;
		ENDPOINTS_DURABLE_OBJECTS: DurableObjectNamespace<import("./src/index").EndpointsDurableObject>;
	}
}
